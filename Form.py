...
def sorting(event):
    ...
    text_recipe = Text(root, wrap = WORD, width = 60, height = 23, font = 'Arial 12 italic')
    ...
    text = Text(root, width = 55, height = 11, font = 'Arial 12')
    text.place(x = 800, y = 535)
    text_recipe.place(x = 800, y = 55)
...
def new_window(event):
    ...
    window.title('EasyMeal')
    window.geometry('620x450')
    window['bg'] = '#3dbde0'
    window.iconbitmap('logog.ico')
